          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Balavj-fx/Serverless-Voting-Application" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://aquamarine-rasia-75.tiiny.site" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Dr. APJ   Abdul Kalam Tribute Website</h3>
              <p> A simple tribute website dedicated to honoring a famous personality, highlighting their life, achievements, and contributions.</p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Balavj-fx/AI-Chatbot-Assistant" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://project1-six-mocha.vercel.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>
              A job application form designed to collect essential details from applicants, including contact information, work experience, and skills.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Balavj-fx/Jupyter-Notebook/tree/main/Credit%20Risk%20Analysis" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://project3-flame-ten.vercel.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
              A visually engaging website using parallax scrolling to create a dynamic user experience with layered effects and smooth transitions.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Balavj-fx/MediBook-Medical-Appointment-Scheduler-with-Health-History" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              ...
              <p>
              A full-fledged restaurant website showcasing the menu, ambiance, customer reviews, and an online booking feature for reservations.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Balavj-fx/Real-Time-Hand-Gesture-Driven-3D-Object-Manipulation" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
            ...
            <div className="body">
              <h3>Youtube Clone</h3>
              <p>
              A Youtube clone that mimics the core features of Youtube, allowing users to upload, view, and interact with video content.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Blog Website</h3>
              <p>
              A blog platform that allows users to write, publish, and manage blog posts with categories, tags, and a comment section for interaction.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
